...
function sumEvenArguments(){
  ...
  for (var i = 0; i < arguments.length; i+= 1)  {
    if (arguments[i] % 2 ===0) sum += arguments[i];
  }

  return sum;
}

function sumEvenArguments2(){
...
console.log(sumEvenArguments2(1,2,3,4)); // 6
console.log(sumEvenArguments2(1,2,6)); // 8
console.log(sumEvenArguments2(1,2)); // 2
console.log("===============");
console.log();
...
function bind(fn, thisArg){
  ...
  return function() {
    ...
    var allArgs = outArgs.concat(innerArgs);
//    console.log(allArgs);
...
function flip(fn, thisArg){
  ...
  return function() {
    var innerArgs = [].slice.call(arguments);
    var allArgs = outArgs.concat(innerArgs).slice(0, fn.length);
//    console.log(allArgs);
